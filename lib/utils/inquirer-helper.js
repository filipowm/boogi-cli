...
export const recommended = (message, value) =>
  `${message} ${chalk.blue.dim.italic("(recommended)")}`;
export const recommendedRequired = (message, value) =>
  `${defaultValue(required(message), value)}`;

// export const mapChoice = (value, description) => `${value} ${explain(" - " + description)}`
