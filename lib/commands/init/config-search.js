...
import { required, noneOption, toChoices, recommended } from "../../utils/inquirer-helper";
import validate, {
  and,
  or,
  not,
...
export default [
  ...
  },
  {
      ...
      default: "Search...",
      validate: notBlank,
      when: answers => whenSearchEnabled(answers) && answers.search.startComponent === 'input'
  },
  {
    type: "number",
    name: "search.debounceTime",
    message: "Time in milliseconds between last keystroke and invoking search operation:",
    advanced: true,
    suffix: 'ms',
    default: 380,
  ...
  },
  {
    ...
    message: "How many words of snippet should be displayed in a single search result?",
    advanced: true,
    default: 22,
    validate: or(blank, greaterThan(0)),
    when: whenSearchEnabled
  ...
  },
  {
    ...
    message: "Should search statistics (results count, search time) be displayed?",
    default: true,
    advanced: true,
    when: whenSearchEnabled
  },
  ...
  },
  {
    ...
    when: answers => whenSearchEnabled(answers) && answers.search.pagination.enabled === true,
    default: 10,
  },
];
